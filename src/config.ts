  ...
  contractsAbi: {
    AlastriaIdentityEntity: {
      setUrlLogo: {
        constant: false,
        inputs: [
          { name: '_addressEntity', type: 'address' },
          { name: '_url_logo', type: 'string' }
        ],
        name: 'setUrlLogo',
        outputs: [],
        payable: false,
      ...
      setUrlCreateAID: {
        ...
        inputs: [
          { name: '_addressEntity', type: 'address' },
          { name: '_url_createAID', type: 'string' }
        ],
      ...
      getEntity: {
        constant: true,
        inputs: [{ name: '_addressEntity', type: 'address' }],
        name: 'getEntity',
        outputs: [
    ...
    AlastriaIdentityIssuer: {
      getEidasLevel: {
        constant: true,
        inputs: [{ name: '_identityIssuer', type: 'address' }],
        name: 'getEidasLevel',
      ...
      updateIdentityIssuerEidasLevel: {
        constant: false,
        inputs: [
          { name: '_identityIssuer', type: 'address' },
    ...
    AlastriaIdentityManager: {
      ...
      addIdentityServiceProvider: {
        constant: false,
        inputs: [{ name: '_identityServiceProvider', type: 'address' }],
      ...
      prepareAlastriaID: {
        constant: false,
        inputs: [{ name: '_signAddress', type: 'address' }],
      ...
      createAlastriaIdentity: {
        constant: false,
        inputs: [{ name: 'addPublicKeyCallData', type: 'bytes' }],
      ...
      PreparedAlastriaID: {
        anonymous: false,
        inputs: [{ indexed: true, name: 'signAddress', type: 'address' }],
        name: 'PreparedAlastriaID',
        type: 'event'
      },
      OperationWasNotSupported: {
        anonymous: false,
        inputs: [{ indexed: true, name: 'method', type: 'string' }],
      ...
      IdentityRecovered: {
        anonymous: false,
        inputs: [
          { indexed: true, name: 'oldAccount', type: 'address' },
          { indexed: false, name: 'newAccount', type: 'address' },
    ...
    Eidas: {
      atLeastLow: {
        constant: true,
        inputs: [{ name: '_eidasLevel', type: 'Eidas.EidasLevel' }],
        name: 'atLeastLow',
        outputs: [{ name: '', type: 'bool' }],
        payable: false,
      ...
      atLeast: {
        constant: true,
        inputs: [
          { name: '_eidasLevel', type: 'Eidas.EidasLevel' },
          { name: '_level', type: 'Eidas.EidasLevel' }
        ],
        name: 'atLeast',
        outputs: [{ name: '', type: 'bool' }],
        payable: false,
    ...
    AlastriaCredentialRegistry: {
      ...
      getSubjectCredentialStatus: {
        ...
        inputs: [
          ...
          { name: 'subjectCredentialHash', type: 'bytes32' }
        ],
      ...
      getIssuerCredentialStatus: {
        ...
        inputs: [
          ...
          { name: 'issuerCredentialHash', type: 'bytes32' }
        ],
      ...
      addIssuerCredential: {
        constant: false,
        inputs: [{ name: 'issuerCredentialHash', type: 'bytes32' }],
      ...
      deleteSubjectCredential: {
        constant: false,
        inputs: [{ name: 'subjectCredentialHash', type: 'bytes32' }],
      ...
      constructor: {
        inputs: [{ name: '_previousPublishedVersion', type: 'address' }],
        payable: false,
        stateMutability: 'nonpayable',
        type: 'constructor'
      },
      SubjectCredentialDeleted: {
        anonymous: false,
        inputs: [
          { indexed: false, name: 'subjectCredentialHash', type: 'bytes32' }
        ],
      ...
      IssuerCredentialRevoked: {
        anonymous: false,
        inputs: [
          { indexed: false, name: 'issuerCredentialHash', type: 'bytes32' },
    ...
    AlastriaPresentationRegistry: {
      getPresentationStatus: {
        ...
        inputs: [
          { name: 'subjectStatus', type: 'uint8' },
          { name: 'receiverStatus', type: 'uint8' }
        ],
      ...
      updateReceiverPresentation: {
        constant: false,
        inputs: [
          { name: 'receiverPresentationHash', type: 'bytes32' },
          { name: 'status', type: 'uint8' }
        ],
      ...
      addSubjectPresentation: {
        constant: false,
        inputs: [
          { name: 'subjectPresentationHash', type: 'bytes32' },
          { name: 'URI', type: 'string' }
        ],
    ...
    AlastriaPublicKeyRegistry: {
      ...
      PublicKeyDeleted: {
        anonymous: false,
        inputs: [{ indexed: false, name: 'publicKey', type: 'string' }],
