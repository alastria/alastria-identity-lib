...
const jwt = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJFUzI1NksifQ.eyJpYXQiOjE0NDA3MTM0MTQuODV9.cnCOBNFSfzpn35pwo2aT74xoH7JzCwmCEAWvKRxwqGV4lUiKLmWeA6V4fnU9-NX8sYNrsrUzY-5g5oEhzQ3mqQ'
const rawPublicKey = '03fdd57adec3d438ea237fe46b33ee1e016eda6b585c3e27ea66686c2ea5358479278a5de700e29faae8e40e366ec5012b5ec63d36ec77e8a2417154cc1d2538'
const rawPrivateKey = '278a5de700e29faae8e40e366ec5012b5ec63d36ec77e8a2417154cc1d25383f'
const tokenPayload = {"iat": 1440713414.85}
//const jsonspr = tokensFactory.presentation.signPresentationRequest(tokenPayload, rawPrivateKey)
const jsonvpr = tokensFactory.presentation.verifyPresentationRequest(jwt, rawPublicKey)
console.log(jsonvpr)
//const jsonsp = tokensFactory.presentation.signPresentation(tokenPayload, rawPrivateKey)
